...
func (p *User) DeepEqual(ano *User) bool {
	...
	if !p.Field6DeepEqual(ano.FollowCount) {
		return false
	}
	if !p.Field7DeepEqual(ano.FollowerCount) {
		return false
	}
	if !p.Field8DeepEqual(ano.IsFollow) {
		return false
	}
	if !p.Field9DeepEqual(ano.LikeCount) {
		return false
	}
	if !p.Field10DeepEqual(ano.VideoCount) {
		return false
	}
	return true
}
...
func (p *User) Field8DeepEqual(src *bool) bool {
...
func (p *Video) DeepEqual(ano *Video) bool {
	...
	if !p.Field9DeepEqual(ano.Author) {
		return false
	}
...
func (p *Video) Field9DeepEqual(src *User) bool {
...
func (p *Comment) Field5DeepEqual(src *User) bool {
