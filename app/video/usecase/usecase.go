...
type VideoUseCase interface {
	Publish(ctx context.Context, userID int64, videoData []byte, contentType, title string, description, category *string, tags []string, isPrivate bool) (string, error)
	...
	GetHotVideos(ctx context.Context, limit int32, category string, lastVisit, lastLike, lastID int64) ([]*model.Video, int64, int64, int64, int64, error)
	...
	SearchVideo(ctx context.Context, keywords string, pageSize, pageNum int32, fromDate, toDate *int64, username *string) ([]*model.Video, int64, error)
}
